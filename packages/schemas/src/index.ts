...
export const searchPitchingLinesFiltersSchema = z.object({
  ...
  team: coercedText.optional(),
  level: z.enum(['first', 'farm']).optional(),
...
export const chatResponseSchema = z.object({
  ...
  answer: z.object({
    ...
    execution_metadata: z.object({
      ...
      correction_guard: z.object({
        inheritanceBlockedReason: z.enum([
          'none',
      ...
      identity_resolution: z.object({
        ...
        status: z.enum(['resolved', 'ambiguous', 'not_found', 'skipped']),
        playerId: z.string().min(1).nullable(),
        candidateCount: z.number().int().nonnegative(),
        candidatePlayerIds: z.array(z.string().min(1)),
