...
export function buildChatQueryParserUserPrompt(
  ...
  return [
    ...
    '- For questions asking which single appearance had the most pitches, such as "今シーズン最も球数が多かった登板" or "球数が最も多かった登板", use search_pitching with sort_by:"pitchCount" and limit:1. For "最も長く投げた登板" or "最長登板", preserve the established QA contract by using aggregate_pitching with sort_by:"inningsPitched" and limit:20. Do not output sort_by:"pitches".',
