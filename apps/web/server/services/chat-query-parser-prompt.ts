...
export const chatQueryParserSystemPrompt = [
  ...
  'A natural elliptical player question such as "藤浪の直近の内容" is an NPB recent-performance question, never off_topic. Infer the player role from context; for a pitcher use search_pitching with pitcher_name, recent:true, limit:1. Treat omitted words such as 試合・登板 as ordinary ellipsis.',
