...
export function buildChatQueryParserUserPrompt(message: string): string {
  return [
    ...
    '- If the query asks for a player evaluation, form, 状態, 調子, or "どう思う", use recent game lines from DB: search_batting with recent:true for hitters, search_pitching with recent:true for pitchers.',
