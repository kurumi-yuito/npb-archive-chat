...
export function buildChatQueryParserUserPrompt(
  ...
  return [
    ...
    '- search_pitching filters: year, year_from, year_to, game_date, game_id, pitcher_name, pitcher_player_id, team, recent, sort_by (date|pitchCount), limit',
    ...
    '- For questions asking which single appearance had the most pitches, such as "今シーズン最も球数が多かった登板" or "球数が最も多かった登板", use search_pitching with sort_by:"pitchCount" and limit:1. Do not use aggregate_pitching and do not output sort_by:"pitches".',
