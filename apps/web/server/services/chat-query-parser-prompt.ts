...
export const chatQueryParserSystemPrompt = [
  ...
  'The intent field is only a repository query intent from the allowed list above. Follow-up classifications such as detail_request, correction_request, recheck_request, context_reference, explanation_request, or scope_clarification are application metadata and MUST NEVER be emitted as intent.',
  'If a follow-up cannot be resolved because usable conversation history is absent, return {"intent":"off_topic","filters":{}}. Never invent a new intent label.',
