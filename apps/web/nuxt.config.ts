...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    npbFreeTokenCapacity: process.env.NPB_FREE_TOKEN_CAPACITY ?? '10',
    npbFreeTokenRefillMinutes: process.env.NPB_FREE_TOKEN_REFILL_MINUTES ?? '120',
    npbGuestGuardEnabled: process.env.NPB_GUEST_GUARD_ENABLED ?? 'true',
